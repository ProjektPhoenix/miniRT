...
SRCS		:= srcs/main.c srcs/exits.c srcs/input/parsing.c srcs/input/parsing_utils.c srcs/input/transfer_input.c \
			...
			srcs/vector_utils/vector_math.c srcs/hit_points_calc/hit_objects.c srcs/display/viewport_and_canvas.c \
      		srcs/color/colors.c srcs/hit_points_calc/find_closest.c srcs/color/color_light_utils.c \
			srcs/hit_points_calc/cylinder.c srcs/input/init_helper.c
OBJS		:= ${SRCS:.c=.o}
SHELL		:= /bin/bash
HDS		:= 
RM		:= rm -rf
